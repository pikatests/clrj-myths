...
const categories = ['MITO', 'HECHO', 'TESTIMONIO']
...
function changeNav(currentCategory) {
  ...
  switch (currentCategory) {
    case 'MITO':
      currentLeft.innerHTML = 'HECHO'
      currentRight.innerHTML = 'TESTIMONIO'
      categoryIconLeft.src = categoryIcons.FACT
      categoryIconRight.src = categoryIcons.TESTIMONY
      break
    case 'HECHO':
      currentLeft.innerHTML = 'TESTIMONIO'
      currentRight.innerHTML = 'MITO'
      categoryIconLeft.src = categoryIcons.TESTIMONY
      categoryIconRight.src = categoryIcons.MYTH
      break
    case 'TESTIMONIO':
      currentLeft.innerHTML = 'MITO'
      currentRight.innerHTML = 'HECHO'
